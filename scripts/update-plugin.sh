#!/usr/bin/env bash
#
# update-plugin.sh — Automatically pull the latest opencode-commandcode plugin
...
#
# The script:
#   1. Checks the latest `@otto-assistant/opencode-commandcode` version on npm.
...
# ── Config ──────────────────────────────────────────────────────────────────
PLUGIN_NAME="@otto-assistant/opencode-commandcode"
